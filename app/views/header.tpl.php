...
<body>
  <header>
      ...
      <div class="container-fluid">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-sm-5 d-flex justify-content-end">
            ...
            <button type="button" class="btn dropdown-toggle color-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              EUR
            </button>
    ...
    <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-light">
      <div class="container-fluid">
        <!-- Navbar Header  -->
        <a href="index.html" class="navbar-brand font-weight-bold">oShop</a>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          ...
          <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
            <!-- Search Button-->
            <div class="nav-item navbar-icon-link icon-section">
            ...
            <!-- Cart Dropdown TODO -->
            <div class="nav-item">
              <a href="#" class="navbar-icon-link"><i class="fa fa-shopping-cart"></i></a>
            </div>
            <button type="button" class="btn btn-secondary btn-sm">2</button>
            <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split btn-sm color-btn" id="dropdownMenuReference" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
